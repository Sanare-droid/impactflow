...
# Always use Settings (env) + asyncpg scheme — never bare postgresql:// from Railway.
...
async def run_async_migrations() -> None:
    # Prefer create_async_engine over async_engine_from_config so % in passwords
    # are not mangled by ConfigParser, and the driver is always asyncpg.
