...
PLAN_SEED: list[dict[str, Any]] = [
    {
        ...
        "sort_order": 0,
        "recommended": False,
        "description": "14-day free trial — 5 users, 2 projects, survey builder, mobile offline, basic dashboards",
    },
    {
        "code": "starter",
        "name": "Starter",
        ...
        "sort_order": 1,
        "recommended": False,
        "description": "10 users — surveys, offline mobile, beneficiaries, reports, basic AI credits",
    },
    {
        "code": "professional",
        "name": "Professional",
        ...
        "sort_order": 2,
        "recommended": True,
        "description": "50 users, unlimited projects — AI Copilot, automation, executive dashboards, API, white-label, integrations",
    },
    {
        "code": "enterprise",
        "name": "Enterprise",
        ...
        "sort_order": 3,
        "recommended": False,
        "description": "Unlimited users — dedicated onboarding, custom domains, SSO, priority support, custom integrations",
    },
    {
        "code": "government",
        "name": "Government",
